...
*************************************************
                MACRO
                MACRO_MVN   &VALUE1,&VALUE2,&LEN1,&LEN2
                OFADBGMEM   &VALUE1,0
                OFADBGMEM   &VALUE2,0
                LA          2,&VALUE1
                LA          3,&VALUE2
