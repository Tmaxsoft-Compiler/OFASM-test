*************************************************
* FILENAME : MVCIN01.asm
* AUTHOR : HYUK KIM
* SYSTEM : OFASM v4 revision 169
*************************************************
                MACRO
                MACRO_MVCIN &VALUE1,&VALUE2,&LEN1,&LEN2
                OFADBGMEM   &VALUE1,0
                OFADBGMEM   &VALUE2,0
                LA          2,&VALUE1
                LA          3,&VALUE2
